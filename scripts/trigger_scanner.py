...
SUBMISSION_AXES: list[dict] = [
    ...
    {
        "num": 3, "name": "내부언어",
        "pattern": r"확신도|MECE|스파인|spine|트리아지|갭렌즈|절대자|C8C|DC\b|OK\b|UP\b|SHE\b|엄브렐러|홈즈|오컴|제1원리|베이지안|아날로지|연역수렴|외과적|백본|스켈레톤|엘베피치|타임스톤|맥가이버|넛지|프리모르템|줌\b|부작업|주작업|제출청소|이쁘니|작업설계자|모래시계|렌즈6|ceo-pipeline|policy-planning|bp-guide|financial-model|UP\s*§|§[A-H]|샤워효과|TRIZ|트리즈",
    },
    {
        "num": 4, "name": "AI흔적",
